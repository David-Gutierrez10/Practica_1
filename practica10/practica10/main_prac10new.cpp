	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glRotatef(movRot,0.0,1.0,0.0);
				//T_rex
				glPushMatrix();
					glTranslatef(0.0,-4.0,0.0);
					glScalef(10,10,10);
					t_rex.GLrender(NULL,_SHADED,1.0);  //_WIRED O _POINTS
				glPopMatrix();

				glPushMatrix();//llanta delantera izquierda
					glTranslatef(10.5,-1.0,-1.5);
				...
				/*glPushMatrix();//llanta tracera izquierda
				...
				glPushMatrix();//llanta tracera derecha
					glTranslatef(-5.0,-1.0,-1.5);
					glRotatef(giroLlanta,1.0,0.0,0.0);
					llanta.GLrender(NULL,_SHADED,1.0);
				glPopMatrix();*/

...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_ima.LoadTGA("ima.tga");
	t_ima.BuildGLTexture();
	t_ima.ReleaseImage();

	t_tierra.LoadTGA("tierra.tga");
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix();
			...
			prisma2 (t_ima.GLindex, t_madera.GLindex);
			glDisable(GL_ALPHA_TEST);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(-10.0, 0.0, 0.0);
			glScalef(0.1, 5.0, 20.0);
		...
		glPushMatrix();
			glTranslatef(-4.5, 4.5, 10.0);
			glScalef(11.0, 14.0, 0.1);
			prisma2(t_madera.GLindex, t_madera.GLindex);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(5.5, 0.5, 10.0);
			glScalef(9.0, 6.0, 0.1);
			prisma2(t_madera.GLindex, t_madera.GLindex);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(9.5, 7.5, 10.0);
			glScalef(1.0, 8.0, 0.1);
			prisma2(t_madera.GLindex, t_madera.GLindex);
		glPopMatrix();
		...
		glPushMatrix();
			...
			prisma2(t_tierra.GLindex, t_tierra.GLindex);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(-4.0, -2.8, 15.0);
			glScalef(5.0, 0.5, 10.0);
			prisma2(t_piso.GLindex, t_piso.GLindex);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(0.0, 0.0, -20.0);
			glScalef(40.0, 5.6, 0.1);
			prisma2(t_cerca.GLindex, t_cerca.GLindex);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(-20.0, 0.0, 0.0);
			glRotatef(180, 0.0, 1.0, 0.0);
			glScalef(0.1, 5.6, 40.0);
			prisma2(t_cerca.GLindex, t_cerca.GLindex);
		glPopMatrix();
		...
		glPushMatrix();
			glTranslatef(-13.25, 0.0, 20.0);
			glRotatef(180, 1.0, 0.0, 0.0);
			glScalef(13.5, 5.6, 0.1);
			prisma2(t_cerca.GLindex, t_cerca.GLindex);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(9.25, 0.0, 20.0);
			glRotatef(180, 1.0, 0.0, 0.0);
			glScalef(21.5, 5.6, 0.1);
			prisma2(t_cerca.GLindex, t_cerca.GLindex);
		glPopMatrix();
